                ...
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-nav-container">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="how.html">How to use</a>
                      </li>
                    </ul>
        ...
        <div class="container">
          <div class="title-style-1-wrap">
            <div class="oh-desktop wow slideInLeft">
              <h1 class="title-style-1 wow slideInRight">CUBRA</h1>
            </div>
          </div>
          <div class="title-style-2-wrap">
            <div class="oh-desktop wow slideInRight">
              <h5 class="title-style-2 wow slideInLeft">Skill Marketplace</h5>
            </div>
        ...
        <div class="container">
          <div class="row row-30 justify-content-center justify-content-lg-end align-items-md-center">
            <div class="col-sm-8 col-md-6 col-lg-5 cube-classic-wrap">
              ...
              <h2 class="wow fadeInLeft" data-wow-delay=".1s">como se pone el chip <br class="d-none d-md-block">latest projects <br class="d-none d-md-block">we completed
              </h2>
